...
call("pwd")
fname = "/spectral/gaobing/inputfile/2018unzipfilelist.txt"
completed_fn = "/spectral/gaobing/inputfile/completed_2018_old.txt"
completed_lockname = "/spectral/gaobing/inputfile/completed_2018_old.txt.lock"
prcessing_fn = "/spectral/gaobing/inputfile/processing_2018_old.txt"
prcessing_lockname = "/spectral/gaobing/inputfile/processing_2018_old.txt.lock"
...
# for fn in glob(filepath+pattern ,recursive=True):
    ...
    with lock:
        try:
            ...
            time.sleep(5)
    try:
        run_atm_corr(Level1(filename), Level2(outdir="/spectral/gaobing/OLCI/done_2018", fmt='netcdf4', datasets=default_datasets+['SPM']), multiprocessing=-1 )
    except OutputExists:
